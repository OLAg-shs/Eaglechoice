    ...
    <div className="fixed inset-0 z-[9999] bg-black flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      >
        ...
        <div className="relative h-full flex flex-col items-start justify-center px-12 md:px-20 text-white">
          <div className="mb-4 transform transition-transform duration-700 group-hover:-translate-y-4">
            <span className="inline-block px-3 py-1 rounded-full bg-blue-500/20 border border-blue-400/30 text-[10px] font-black uppercase tracking-[0.2em] mb-2">
              Marketplace
            </span>
            <h2 className="text-6xl md:text-8xl font-black tracking-tighter transition-all duration-700 group-hover:tracking-normal group-hover:text-blue-400">
              Buyer
            </h2>
          </div>
      ...
      >
        ...
        <div className="relative h-full flex flex-col items-end justify-center px-12 md:px-20 text-white text-right">
          <div className="mb-4 transform transition-transform duration-700 group-hover:-translate-y-4">
            <span className="inline-block px-3 py-1 rounded-full bg-purple-500/20 border border-purple-400/30 text-[10px] font-black uppercase tracking-[0.2em] mb-2">
              Opportunity
            </span>
            <h2 className="text-6xl md:text-8xl font-black tracking-tighter transition-all duration-700 group-hover:tracking-normal group-hover:text-purple-400">
              Seller
            </h2>
          </div>
          ...
          <div className="max-w-md opacity-0 translate-y-8 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 delay-100 flex flex-col items-end">
            <p className="text-xl md:text-2xl font-light text-purple-100/80 mb-6 leading-relaxed">
              Scale your business instantly. Reach thousands of customers and manage your store like a pro.
            </p>

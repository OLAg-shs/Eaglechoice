...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gray-50 dark:bg-neutral-950 px-4 py-8 transition-colors duration-500">
      ...
      <Footer className="w-full relative z-20 bg-transparent border-none py-4" />
    </div>
  )
}

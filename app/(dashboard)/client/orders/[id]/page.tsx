...
export default async function OrderDetailPage({ params }: { params: { id: string } }) {
  ...
  if (order.user_id !== user.id) redirect("/client/orders")
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <Link href="/client/orders" className="flex items-center text-sm text-gray-500 hover:text-gray-900 transition-colors">
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                {order.form_data?.messaging_enabled ? (
                  <Link href={`/client/messages`} className="flex items-center justify-center w-full gap-2 py-2.5 px-4 bg-gray-900 text-white rounded-md text-sm font-medium hover:bg-gray-800 transition-colors">
